...
impl System for integrationSystem {
    ...
    fn new() -> Self {
        ...
        // build connection: 
            screen.actual_speed = Some(channel.0.subscribe());
        //let channel = tokio::sync::broadcast::channel::<>(100);
        // build connection: 
            //speed_voter.speed = Some(channel.0);
        // build connection: 
        ...
        // build connection: 
            screen.desired_speed = Some(channel.0.subscribe());
        let channel = crossbeam_channel::unbounded();
        // build connection: 
